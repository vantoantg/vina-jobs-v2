    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                       href="<?= Helper::createUrl(['front/jobs/post-cv']) ?>">Post a
                                    CV</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                       href="<?= Helper::createUrl(['front/jobs/post-jobs']) ?>">Post a
                                    Job</a></li>
                            ...
                            <li role="presentation"><a href="<?= Helper::createUrl(['front/user/profile']) ?>">My
                                    page</a></li>
            ...
            <ul class="main-nav nav navbar-nav navbar-right">
                <li class="wow fadeInDown" data-wow-delay="0s"><a class="<?= Helper::active('front/default/index') ?>"
                                                                  href="<?= Helper::createUrl(['front/default/index']) ?>">Trang
                        chủ</a></li>
                <li class="wow fadeInDown" data-wow-delay="0.1s"><a class="<?= Helper::active('site/job-seekers') ?>"
                                                                    href="<?= Helper::createUrl(['site/job-seekers']) ?>">Người
                        tìm việc</a></li>
                <li class="wow fadeInDown" data-wow-delay="0.2s"><a class="<?= Helper::active('site/employeers') ?>"
                                                                    href="<?= Helper::createUrl(['site/employeers']) ?>">Nhà
                        tuyển dụng</a></li>
                <li class="wow fadeInDown" data-wow-delay="0.3s"><a class="<?= Helper::active('site/about-us') ?>"
                                                                    href="<?= Helper::createUrl(['site/about-us']) ?>">Giới
                        thiệu</a></li>
                <li class="wow fadeInDown" data-wow-delay="0.4s"><a class="<?= Helper::active('site/blog') ?>"
                                                                    href="<?= Helper::createUrl(['site/blog']) ?>">Blog</a>
                </li>

                <li class="wow fadeInDown" data-wow-delay="0.5s"><a class="<?= Helper::active('site/contact') ?>"
                                                                    href="<?= Helper::createUrl(['site/contact']) ?>">Liên
                        hệ</a></li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
