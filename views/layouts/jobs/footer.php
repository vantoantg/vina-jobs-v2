...
<footer>
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-sm-6 footerleft <?= \app\library\helper\Helper::wowClass() ?> fadeInLeft" data-wow-delay="0.4s">
			...
			<div class="col-md-3 col-sm-6 paddingtop-bottom <?= \app\library\helper\Helper::wowClass() ?> fadeInRight" data-wow-delay="0.3s">
			...
			<div class="col-md-2 col-sm-6 paddingtop-bottom <?= \app\library\helper\Helper::wowClass() ?> fadeInRight" data-wow-delay="0.4s">
