	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-sm-6 footerleft ">
				<div class="logofooter"> <img src="<?= \app\library\helper\Helper::homeUrl()?>web/template/jobs/img/logo-ft.png" alt="<?= Yii::$app->params['siteName'] ?>" class="wow pulse" style="max-height: 60px" data-wow-delay="1s"></div>
