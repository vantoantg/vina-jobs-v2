        ...
        <div class="row main">
            <div class="main-login main-center">
                <div class="content-page">
                    ...
                    <div class="col-xs-12 text-center <?= Helper::getInstance()->wowClass(); ?> zoomInDown animated"
                         data-wow-delay="0.3s">
                        <a role="menuitem" tabindex="-1"
                           href="<?= Helper::getInstance()->createUrl(['front/user/update-candidate']); ?>"><i class="far fa-edit"></i>
