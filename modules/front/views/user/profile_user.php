			...
			<div class="card">
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active ovf-h" id="profile">
						<div class="row">
							<div class="col-xs-12 toppad <?= \app\library\helper\Helper::getInstance()->wowClass(); ?> fadeInUp" data-wow-delay="0.1s">
								<div class="panel panel-info">
											...
											<div class=" col-md-9 col-lg-9">
												<table class="table table-user-information">
													...
													<tr>
														...
														<td>
															<!--<img alt="User Pic"
															     src="<?/*= Helper::getInstance()->imgRender('/'.Common::currentUser('avatar'), 150, 150, 'avatar'); */?>"
									...
									<div class="panel-footer">
                                        <a href="<?= Helper::getInstance()->createUrl(['front/user/update-candidate']); ?>?r=<?= Helper::getInstance()->encrypt(Yii::$app->request->getUrl().'#jobs'); ?>"class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-edit"></i> Cập nhật thông tin</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="job-posts table-responsive">
								<table class="table list-jobs">
									<tr class="odd <?= \app\library\helper\Helper::getInstance()->wowClass(); ?> fadeInUp" data-wow-delay="0.1s">
										<td class="tbl-logo">
											<img src="<?= Helper::getInstance()->homeUrl(); ?>web/template/jobs/img/job-logo1.png" alt=""></td>
									...
									<tr class="even <?= \app\library\helper\Helper::getInstance()->wowClass(); ?> fadeInUp" data-wow-delay="1.1s">
									...
									<tr class="odd <?= \app\library\helper\Helper::getInstance()->wowClass(); ?> fadeInUp" data-wow-delay="1.2s">
										<td class="tbl-logo"><img
									...
									<tr class="even <?= \app\library\helper\Helper::getInstance()->wowClass(); ?> fadeInUp" data-wow-delay="1.3s">
										<td class="tbl-logo">
											<img src="<?= Helper::getInstance()->homeUrl(); ?>web/template/jobs/img/job-logo4.png"
											     alt="">
										</td>
										<td class="tbl-title">
									...
									<tr class="odd <?= \app\library\helper\Helper::getInstance()->wowClass(); ?> fadeInUp" data-wow-delay="1.4s">
										<td class="tbl-logo">
											<img src="<?= Helper::getInstance()->homeUrl(); ?>web/template/jobs/img/job-logo5.png"
											     alt="">
										</td>
										<td class="tbl-title">
									...
									<tr class="odd <?= \app\library\helper\Helper::getInstance()->wowClass(); ?> fadeInUp" data-wow-delay="1.5s">
										<td class="tbl-logo"><img
									...
									<tr class="odd <?= \app\library\helper\Helper::getInstance()->wowClass(); ?> fadeInUp" data-wow-delay="1.6s">
										<td class="tbl-logo"><img
													src="<?= Helper::getInstance()->homeUrl(); ?>web/template/jobs/img/job-logo4.png"
													alt=""></td>
										<td class="tbl-title"><h4>Internship Designer <br><span class="job-type">full time</span>
